...
public class StoreManage2 extends UnicastRemoteObject implements StoreInterface{
	...
	public StoreManage2(String nom) throws RemoteException{
		super();
		this.nom = nom;
	}
	...
	public float getPrice(String ingredient) throws RemoteException {
		String Fichier = "C:\\Users\\PARISTONE\\eclipse-workspace\\DJOYOU_Carlos_projet\\src\\ServeurMachine2/Magazin2.txt";
